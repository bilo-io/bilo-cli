...
MapScss() {
    ...
    setColor green
    echo "[+] src/components/map/map.scss"
    resetColor

    echo "@import '~leaflet/dist/leaflet.css';" > ./src/components/map/map.scss
...
SetupLeaflet(){
    ...
    mkdir ./src/components/map
    cp ./.shell/blueprints/map.leaflet.js > ./src/components/map/map.js
...
SetupOpenLayers(){
    ...
    mkdir ./src/components/map
    cp ./.shell/blueprints/map.openlayers.js > ./src/components/map/map.js
    echoColor 'green' "[+] src/components/map/map.js"
}
MapMenu() {
    echo -ne "
...
AngularMap() {
    MapScss
    echoColor 'green' "[+] src/components/map/map.js"
    cp ./.shell/blueprints/map-leaflet.ts > ./src/components/map/map.component.ts
}
